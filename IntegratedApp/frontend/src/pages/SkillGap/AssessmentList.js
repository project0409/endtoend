  ...
  return (
    <div className="page-container">
      <div className="page-header">
        ...
        <button className="btn" onClick={() => navigate('/assessments/create')}>New Assessment</button>
      </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <button className="btn" onClick={() => navigate('/assessments/create')}>Create Your First Assessment</button>
        </div>
      ) : (
          ...
          {assessments.map((assessment) => (
            <div key={assessment._id} className="assessment-card">
              ...
              <div className="card-actions">
                <button className="btn-small" onClick={() => navigate(`/assessments/${assessment._id}`)}>View Details</button>
